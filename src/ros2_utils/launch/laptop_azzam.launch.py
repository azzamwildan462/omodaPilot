...
def generate_launch_description():
    ...
    dummy_video2ros = Node(
        ...
        parameters=[{
            ...
            "camera_info_topic": "/camera/rs2_cam_main/color/camera_info",
            "depth_topic": "/camera/rs2_cam_main/aligned_depth_to_color/image_raw",
        }],
        output="screen",
        respawn=True,
    )
    ...
    road_segmentation = Node(
        ...
        parameters=[{
            ...
            "depth_image_topic": "/camera/rs2_cam_main/aligned_depth_to_color/image_raw",
