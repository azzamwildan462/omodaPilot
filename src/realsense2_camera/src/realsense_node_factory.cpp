...
std::string api_version_to_string
(
    int version
)
{
...
void RealSenseNodeFactory::changeDeviceCallback
(
...
void RealSenseNodeFactory::getDevice
(
...
void RealSenseNodeFactory::tryGetLogSeverity
(
...
std::string RealSenseNodeFactory::parseUsbPort
(
    std::string line
)
{
