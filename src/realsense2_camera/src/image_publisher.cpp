...
image_rcl_publisher::image_rcl_publisher
(
    rclcpp::Node& node,
...
void image_rcl_publisher::publish
( 
    sensor_msgs::msg::Image::UniquePtr image_ptr
)
{
...
image_transport_publisher::image_transport_publisher
(
    rclcpp::Node & node,
    const std::string & topic_name,
    const rmw_qos_profile_t& qos
...
void image_transport_publisher::publish
(
    sensor_msgs::msg::Image::UniquePtr image_ptr
)
{
