...
# ros2 launch realsense2_camera d400e_multi_camera_rs_launch.py ip_address1:=<DEVICE1_IP_ADDR> ip_address2:=<DEVICE2_IP_ADDR>
# ros2 launch realsense2_camera d400e_multi_camera_rs_launch.py config_file1:=src/realsense2_camera/config/d400e_multi_camera_1.yaml config_file2:=src/realsense2_camera/config/d400e_multi_camera_2.yaml
...
def generate_launch_description():
    ...
    return LaunchDescription(
        ...
        [
        OpaqueFunction(function=d400e_rs_launch.launch_setup,
